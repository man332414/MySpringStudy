...
<div class="container">
	<form:form modelAttribute="order" class="form-horizontal">
		...
		<div class="row">
			<div class="col-md-9">
				<address>
					...
					주소 : ${order.customer.address.addressName}  ${order.customer.address.detailName} (${order.shipping.address.country})<br>
		...
		<button name="_eventId_orderConfirmed" class="btn btn-success">주문완료</button>
